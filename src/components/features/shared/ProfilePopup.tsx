...
export default function ProfilePopup({ onClose, onLogout, user, profileRoute = ROUTES.PROFILE, helpRoute = ROUTES.HELP_CENTER }: ProfilePopupProps) {
  ...
  const displayEmail = user?.email ?? 'admin@flutterflirt.com';
